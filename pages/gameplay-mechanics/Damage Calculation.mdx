...
In this example, a shell with 400 base damage hits a tank’s engine module, which has a critical multiplier of 1.0. The shell damage is multiplied by the crit multiplier (1.5) and the universal modifier (1.0), resulting in 600 damage to the tank. The engine itself takes 50 damage, reducing its health from 200 to 150.
